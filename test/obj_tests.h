...
bool test_register_obj(seljs::State &state) {
    Foo foo_instance(1);
...
bool test_register_obj_member_variable(seljs::State &state) {
    Foo foo_instance(1);
...
bool test_register_obj_to_table(seljs::State &state) {
    Foo foo1(1);
    Foo foo2(2);
    Foo foo3(3);
...
bool test_mutate_instance(seljs::State &state) {
    Foo foo_instance(1);
...
bool test_multiple_methods(seljs::State &state) {
    Foo foo_instance(1);
...
bool test_register_obj_const_member_variable(seljs::State &state) {
    Foo foo_instance(1);
...
bool test_bind_vector_push_back(seljs::State &state) {
...
bool test_bind_vector_push_back_string(seljs::State &state) {
...
bool test_bind_vector_push_back_foos(seljs::State &state) {
...
bool test_obj_member_return_pointer(seljs::State &state) {
...
bool test_obj_member_return_ref(seljs::State &state) {
    state["Foo"].SetClass<Foo, int>("get", &Foo::GetX);
    FooHolder fh{4};
...
bool test_obj_member_return_val(seljs::State &state) {
    state["Foo"].SetClass<Foo, int>("get", &Foo::GetX);
    FooHolder fh{4};
...
bool test_obj_member_wrong_type(seljs::State &state) {
    state["Foo"].SetClass<Foo, int>();
