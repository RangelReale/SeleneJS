...
private:
    ...
    void _register_ctor(duk_context *state) {
        _ctor.reset(new A(state, _metatable_name.c_str(), _name.c_str()));
    }
    ...
    void _register_members(duk_context *state) {}
