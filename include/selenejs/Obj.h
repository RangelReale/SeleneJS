...
private:
    ...
    template <typename M>
    void _register_member(duk_context *state,
                          T *t,
    ...
    void _register_member(duk_context *state,
        ...
        _funs.emplace_back(
            seljs::make_unique<ObjFun<0, void, M>>(
    ...
    void _register_member(duk_context *state,
        ...
        _funs.emplace_back(
            seljs::make_unique<ObjFun<arity, Ret, Args...>>(
    ...
    void _register_members(duk_context *state, T *t) {}
...
public:
    Obj(duk_context *state, T *t, Members... members) {
